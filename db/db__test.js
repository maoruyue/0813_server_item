...
// 1.2. 连接指定数据库(URL只有数据库是变化的)
mongoose.connect('mongodb://localhost:27017/gzhipin_test01')
// 1.3. 获取连接对象
...
function testFind(){
  ...
  //查找一个
  UserModel.findOne({_id: '5b71258d048cdd30f032d63f'}, function (error, user){
...
// 3.3. 通过Model的findByIdAndUpdate()更新某个数据
function testUpdate() {
  UserModel.findByIdAndUpdate({_id: '5b71258d048cdd30f032d63f'}, {username: '111'}, function (err, user) {
